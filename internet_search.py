...
class InternetSearcher:
    ...
    def should_search_internet(self, ai_response, user_question):
        ...
        factual_keywords = [
            "когда родился", "когда ты родился", "когда родилась", "когда ты родилась",
            "когда умер", "когда ты умер", "когда умерла", "когда ты умерла",
            "когда написал", "когда создал", "когда создала", "когда написала",
            "в каком году", "какой год", "год рождения", "год смерти",
            "где родился", "где ты родился", "где родилась", "где ты родилась",
            "где умер", "где ты умер", "где умерла", "где ты умерла",
            "где написал", "где создал",
            "что такое", "кто такой", "кто такая", "кто такие",
            "какое первое произведение", "какое последнее произведение", "какое главное произведение",
            "первое произведение", "последнее произведение", "главное произведение", "главный роман",
            "сколько произведений", "сколько книг", "сколько работ",
            "дата рождения", "дата смерти", "биография",
            "какой роман", "какая книга", "какое стихотворение",
            "твоя биография", "расскажи о жизни", "твоя жизнь",
